...
> Sites which:
> - Host a large amount of AI-generated content, especially those from companies who heavily invest in AI (e.g., Adobe, Facebook, TikTok, etc). Certain popular pro-AI websites (like Amazon, Reddit, Scratch, YouTube, etc.) are whitelisted because they provide good percentages of valuable content to AI slop, though they apparently decrease by day. This ruleset is probably more "nuclear" than most others.
