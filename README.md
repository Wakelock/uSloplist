...
> - A menu should pop up, then click "Unblock". If you imported uSloplist, that would remove it from your list. If you subscribed to uSloplist, that would add the site with an additional "@" at the line's beginning to your own list.
